public class Engine {
    ...
    void run() {
        ...
        // Update debug button color based on debug state
        if (debug) {
            DegubButton.setBoxColor(color(100, 200, 100));  // Green when enabled
        } else {
            DegubButton.setBoxColor(color(250));  // White when disabled
        }
