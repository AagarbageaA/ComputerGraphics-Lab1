public class ShapeRenderer{
    ...
    public boolean allowRendering = true; // Flag to control rendering
    
    public ShapeRenderer(){
      box = new Box(20,50,width-220,height-100); // Adjusted width for narrower palette (200px + 20px margin)
      box.setBoxColor(250);
    ...
    public void run(){      
      ...
      if(renderer!=null && allowRendering) renderer.render();
    }
