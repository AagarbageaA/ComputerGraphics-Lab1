public class ShapeRenderer {
    ...
    public void run() {
        ...
        // Draw all shapes - they will use cache if transform hasn't changed
        for (Shape s : shapes) {
            s.drawShape(false);
        }
    ...
    public void setShape(Shape s) {
        ...
        for (int i = 0; i < rotation_slider.length; i++) {
            rotation_slider[i] = new Slider(box.pos.add(new Vector3(40, 30 + i * 20 + 100, 0)),
                    new Vector3(box.pos.x + 40, box.pos.x + 150, 0), new Vector3(-6.28, 6.28, 0), true);
        }
    ...
    public void run() {
        ...
        if (shape != null) {
            ...
            for (int i = 0; i < position_slider.length; i++) {
                ...
                text(nf(position_slider[i].value(), 0, 2), box.pos.x + 170, position_slider[i].pos.y + 5);
            ...
            for (int i = 0; i < rotation_slider.length; i++) {
                ...
                text(nf(rotation_slider[i].value(), 0, 2), box.pos.x + 170, rotation_slider[i].pos.y + 5);
            ...
            for (int i = 0; i < scale_slider.length; i++) {
                ...
                text(nf(scale_slider[i].value(), 0, 2), box.pos.x + 170, scale_slider[i].pos.y + 5);
                scale_slider[i].show();
